...
namespace ReservationSystem.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public TwoFactorAuthenticationModel(
            UserManager<ReservationSystem.Models.ApplicationUser> userManager, SignInManager<ReservationSystem.Models.ApplicationUser> signInManager, ILogger<TwoFactorAuthenticationModel> logger)
        {
